...
class glt_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'glt_widget', // Base ID
			__('WP Translator', 'text_domain'), // Name
			array( 'description' => __( 'Add the WP Translator website tool.', 'text_domain' ), ) 
		);
	}
...
function register_foo_widget_translator() {
    register_widget( 'glt_widget' );
}
add_action( 'widgets_init', 'register_foo_widget_translator' );